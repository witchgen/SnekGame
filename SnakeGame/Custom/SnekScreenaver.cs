...
namespace SnakeGame.Custom
{
    public class SnekScreensaver : SkiaLayout
    {
        ...
        public SKColor StarColor { get; set; } = SKColors.White;
        public SKColor BgColor { get; set; } = new SKColor(43, 56, 81);
        ...
        private DateTime _tickCheckTime = DateTime.UtcNow;
        ...
        public SnekScreensaver()
        {
            ...
            InitStars();
            StartTimer();
            Debug.WriteLine("IsCacheGPU? "+ IsCacheGPU);
        }
        ...
        private void StartTimer()
        {
            ...
            _timer.Tick += (s, e) =>
            {
                ...
                if ((now - _tickCheckTime).TotalSeconds >= 1)
                {
                    System.Diagnostics.Debug.WriteLine($"Ticks/sec: {_tickCount}");
                    _tickCount = 0;
                    _tickCheckTime = now;
                }
